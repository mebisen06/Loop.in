...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = isRegister
            ? { email, password, enrollment_number: enrollment }
            : { email, password };
            ...
            >
                ...
                <motion.div variants={itemVariants} className="space-y-3 mb-6">
                    <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        type="button"
                        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-gray-900 font-bold py-3 px-4 rounded-lg transition-colors duration-150 border border-gray-300"
                    >
